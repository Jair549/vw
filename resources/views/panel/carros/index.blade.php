...
<head>
    ...
    @vite(['resources/scss/panel.scss'])

</head>

<body>

    @extends('panel.partials.flash-messages')
    ...
    <section class="dashboard">
        ...
        <div class="content">
                    ...
                    <div class="user-menu">
                        <div class="dropdown dropleft">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item logoff" href="{{ route('user.admin.edit', Auth::user()->id) }}">
                                    <span>Perfil</span>
                                </a>
                                <a class="dropdown-item logoff" href="{{ $apiUrl }}">
            ...
            <div class="footer">
                <span class="title">&copy; {{ date('Y') }} lorem<span>Ipsum</span></span>
            </div>
        </div>

    </section>

    @vite(['resources/js/app.js', 'resources/js/panel/functions.js'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const logoMenu = document.querySelector('.sidebar .container-toggle-menu .link');
            btnMenuCollaspse.addEventListener('click', () => {
                if (!closed) {
                    ...
                    logoMenu ? (logoMenu.style.display = "none") : null;
                } else {
                    closed = !closed;
                    ...
                    logoMenu ? (logoMenu.style.display = "block") : null;
                }
