            ...
            <div class="form-group">
                <div class="custom-input-file">
                    ...
                    <div class="container-temp-file">
                        @if($my_page->logo != '')
                        <img class="image" src="{{ asset($apiUrl.'/storage/'.$my_page->logo) }}" />
                        <button class="btn-delete" onclick="removeFile(event, 'container-temp-file', '{{$apiUrl}}/painel/my-page/delete-image/logo')">
